    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::is('pengolah*') ? 'active' : '' }}">
                    <a href="/pengolah" class="sidebar-link">
                        <i class="bi bi-speedometer"></i>
                        <span>Dashboard</span>
                    </a>
                </li>

                <li class="sidebar-item {{ Request::is('suratMasuk*') ? 'active' : '' }}">
                    <a href="/suratMasukPengelola" class="sidebar-link">
                        <i class="fas fa-mail-bulk"></i>
                        <span>Surat Masuk</span>
                    </a>
                </li>

                <li class="sidebar-item {{ Request::is('suratKeluar*') ? 'active' : '' }}">
                    <a href="/suratKeluarPengelola" class="sidebar-link">
                        <i class="fas fa-mail-bulk"></i>
                ...
                {{-- <li class="sidebar-item {{ Request::is('account*') ? 'active' : '' }}">
                    <a href="/account/{{ Auth::id() }}/edit" class="sidebar-link">
