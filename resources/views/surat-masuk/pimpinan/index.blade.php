                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex">
                                                ...
                                                <a href="/suratMasukPimpinan/{{ $suratMasuk->id }}" class="badge bg-success text-bg-dark mx-1 py-2" title="Detail">
                                                    <span class="bi bi-eye-fill"></span>
                                                </a>
                                                @else
                                                <a href="/suratMasukPimpinan/pending/{{ $suratMasuk->id }}" class="badge bg-success text-bg-dark mx-1 py-2" title="Detail">
                                                    <span class="bi bi-eye-fill"></span>
                                                </a>
                                                @endif
                                            </div>
