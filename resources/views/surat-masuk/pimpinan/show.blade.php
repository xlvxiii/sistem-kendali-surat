...
@section('content')
    <div id="main">
        ...
        <div class="page-content">
            <a href="{{ url('suratMasukPimpinan') }}" class="btn btn-primary mb-3">
            ...
            <div class="modal fade" id="disposisiModal" tabindex="-1" aria-labelledby="disposisiModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="post" action="/suratMasukPimpinan/{{ $suratMasuk->id }}">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="row">
                                        <table class="display table table-borderless table-hover table-striped fs-6">
                                            <tr>
                                                <td style="width: 20%">{{ 'Instruksi' }}</td>
                                                <td>{{ ':' }}</td>
                                                <td>{{ ucwords($suratMasuk->DisposisiKedua->jenis_disposisi) }}</td>
                                            </tr>
                                            <tr>
                                                <td>{{ 'Ditujukan' }}</td>
                                                <td>{{ ':' }}</td>
