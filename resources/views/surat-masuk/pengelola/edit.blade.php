                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('Edit Surat Masuk') }}</h4>
                        </div>

                        {{-- form layout --}}
                        <div class="card-content">
                            <div class="card-body">
                                <form action="/suratMasukPengelola/{{ $suratMasuk->id }}" method="post" enctype="multipart/form-data" id="update-form" class="form form-vertical">
                                    @method('put')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
