                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="suratKeluarTable" class="display table table-borderless table-hover table-striped table-responsive fs-6">
                            <caption style="caption-side: top">Data Surat Keluar</caption>
                            <thead class="">
                                <tr>
                                    <th>No</th>
                                    <th>No. Surat</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex">
                                                ...
                                                <a href="/suratKeluarPengelola/{{ $suratKeluar->id }}/edit" class="badge bg-warning text-bg-dark mx-1" title="Edit">
                                                    <span class="bi bi-pencil-fill"></span>
                                                </a>
                                                <form action="/suratKeluarPengelola/{{ $suratKeluar->id }}" method="post" id="{{ 'delete-form' . $loop->iteration }}" class="d-inline">
                                                    @method('delete')
                                                    @csrf
