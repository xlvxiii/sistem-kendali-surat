...
@section('content')
    <div id="main">
        ...
        <div class="page-content">
            <a href="{{ url('suratKeluarPengelola') }}" class="btn btn-primary mb-3">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Tambah Surat Keluar') }}</h4>
                            </div>

                            {{-- form layout --}}
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="/suratKeluarPengelola" method="post" enctype="multipart/form-data" class="form form-vertical">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
